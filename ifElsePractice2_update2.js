    ...
    switch (baiTap){
        ...
        case 10:
            ...
            if (tieu_Thu < 0 ){
                ...
                }else if (tieu_Thu<=100){
                    gia_Dien = 1678 * 50 + (tieu_Thu - 50)*1734+(1678 * 50 + (tieu_Thu - 50)*1734)*10/100;
                    alert("Tiền điện bạn phải đóng cho tháng này (bao gồm VAT) là: "+gia_Dien+" đồng");
                }else if(tieu_Thu<=200){
                    gia_Dien = 1678 * 50 + 50*1734 +(tieu_Thu - 100)*2014+(1678 * 50 + 50*1734 +(tieu_Thu - 100)*2014)*10/100;
                    alert("Tiền điện bạn phải đóng cho tháng này (bao gồm VAT) là: "+gia_Dien+" đồng");
                }
                else if(tieu_Thu<=300){
                    gia_Dien = 1678 * 50 + 50*1734 +100*2014+(tieu_Thu-200)*2536+(1678 * 50 + 50*1734 +100*2014+(tieu_Thu-200)*2536)*10/100;
                    alert("Tiền điện bạn phải đóng cho tháng này (bao gồm VAT) là: "+gia_Dien+" đồng");
                }else if (tieu_Thu<=400){
                    gia_Dien = 1678 * 50 + 50*1734 +100*2014+100*2536+(tieu_Thu-300)*2834+(1678 * 50 + 50*1734 +100*2014+100*2536+(tieu_Thu-300)*2834)*10/100;
                    alert("Tiền điện bạn phải đóng cho tháng này (bao gồm VAT) là: "+gia_Dien+" đồng");
                }else{
        ...
        if (thuNhap_tinhthue<=0){
            ...
            if (thuNhap_tinhthue <= 5000000) {
                ...
                alert("Thuế thu nhập cá nhân phải nộp = " + thueThunhapCN + " đồng");
            } else if (thuNhap_tinhthue <= 80000000) {
